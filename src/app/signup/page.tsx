...
export default function SignupPage() {
  const { signup, signInWithGoogle, user, loading: authLoading, isFirebaseConfigured } = useAuth();
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      await signup(values.firstName, values.lastName, values.email, values.password, getRedirectPath());
    } catch (error: any) {
    ...
    <div className="flex items-center justify-center py-12">
      <Card className="mx-auto max-w-sm w-full">
        <CardHeader>
          ...
          <CardDescription>
            Create an account to get started with larger file uploads.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
